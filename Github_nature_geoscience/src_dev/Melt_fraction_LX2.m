...
for i = 1:marknum
    ...
    switch rock_type
        ...
        % 12 = ocreanic crust, Basalt: latent heat 380 kJ/kg
        case {12} % Liang changed, was {4, 16} %was 16
            % Solidus Temperature
            if (P<1600)
        ...
        case {4, 6,18,11} % weakzoon,11 in the previous version
            % Solidus Temperature
            if (P<1200)
                ts=889+17900/(P+54)+20200/(P+54)^2;
            else
        ...
        % 10 = Hydrated mantle (wet): latent heat 400 kJ/kg
        case 10 % wet upper mantle
            % Solidus Temperature
            if (P<2400)
                ts=1240+49800/(P+323);
            else
