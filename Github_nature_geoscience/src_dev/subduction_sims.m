...
function OutputDIR=subduction_sims(modelrun)
...
% Global variables
global microcontinent_right plate_age_old ridge_loc ridge_vel
% global melting
global modeltime output_freq
...
switch modelrun
        ...
        Kf = -1; % bedrock river incision rate meters^(1-2m)/yr  % Turn off incicision Kf<0
        Kd = 1;  % bedrock transport coefficient (diffusivity) meters^2/yr
        tstp = 1e3; % (m); topography resolution
        
        InputGrid = '/Users/rmoucha/Research/MATLAB/ThermoMech2D/InputModels/M0ad_grid';
        InputModel = '/Users/rmoucha/Research/MATLAB/ThermoMech2D/InputModels/forced_subduction';
        InputBC = '/Users/rmoucha/Research/MATLAB/ThermoMech2D/InputModels/M6_bc';
        
        OutputDIR = '/Users/rmoucha/Research/MATLAB/ThermoMech2D/output/subduction_S10';
       ...
       % topography/erosion/sedimentation
        Kf = 1e-5; % bedrock river incision rate meters^(1-2m)/yr
        Kd = 1;  % bedrock transport coefficient (diffusivity) meters^2/yr
        tstp = 1e3; % (m); topography resolution
