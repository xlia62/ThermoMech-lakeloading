...
MatProp{11} = 'Magmatic source region';   %<---- changed from hydrated mantle
...
MPL(3,1) = 1e+6;              % C0, Pa
MPL(3,2) = 1e+6;              % C1, Pa
MPL(3,3) = 0.6;              % sin(FI0) strong
MPL(3,4) = 0.1;             % sin(FI1) weak
MPL(3,5) = 0;                 % GAM0
MPL(3,6) = 1;                 % GAM1
...
% -------------------------------------------------------------------------
MRHO(4,1) = 2700;             % standard density, kg/m^3
...
MMU(4,1) = 1e+10;               % shear modulus, Pa
MPL(4,1) = 1e+6;              % C0, Pa
MPL(4,2) = 1e+6;              % C1, Pa
MPL(4,3) = 0.2;                 % sin(FI0)
...
MKT(4,2) = 807;               % a, W/m
MHR(4,1) = 1.0e-6;              % radiogenic heat production, W/m^3
...
MFLOW(11,8) = 1e-5;            % AD, 1/s/MPa^n (unknown)
MFLOW(11,9) = 1;              % n
