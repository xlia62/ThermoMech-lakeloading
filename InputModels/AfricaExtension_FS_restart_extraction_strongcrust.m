...
TheunissenMaterials_withlake_strongcrust_dry
...
global step2restart;
% step2restart = 69; 
load(['../output/AfricaModels2022/Lake_model_extraction/',...
'reference_strongcrust_dry/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/Lake_model_extraction/',...
'reference_strongcrust_dry/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_model_extraction/reference_strongcrust_dry/bounds.mat')
...
global lake_level_change max_lake_level_change
% lake_level_change = true;

% Sea level Tracking (m) set to empty if no water
% Water depth = sticky_layer - water_lev
water_lev = 20000; %[];%10750;%20200; max of lake level 
water_lev_bot = water_lev + max_lake_level_change; % min of lake level, 800 m water level change, was 24000
