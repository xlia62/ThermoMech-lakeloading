...
MFLOW(10,5)=17;               % Va, cm^3 ===> *1e-6 for J/Pa, or *0.1 for J/bar
                            % uni-axial compression % Lab to model factor
n = MFLOW(10,3);                            
MFLOW(10,6)= 1/2^((n-1)/n)/3^((n+1)/2/n);  
MMU(10,1)=6.7e+10;             % shear modulus, Pa
MPL(10,1)=30e+6;              % C0, Pa
MPL(10,2)=30e+6;              % C1, Pa
...
plate_age_old = 80e6*yr2sec;  % Subducting
...
DepthY = oceanic_lith_thick_old-10e3;
...
for mm1 = 1:marknum
    ...
    % Weak zone
     if (MY(mm1)> bot_ocrust2 && MY(mm1)<=oceanLAB_young && MX(mm1)>= xsize0 - oceanic_lith_thick_young)
          MI(mm1) = 11;
     end
