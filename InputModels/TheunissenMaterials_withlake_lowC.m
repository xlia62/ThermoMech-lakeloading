...
% MPL(4,1) = 10e+6;              % C0, Pa,  10e6 From April
% MPL(4,2) = 1e+6;              % C1, Pa,      1e6 From April
% MPL(4,3) = 0.6;                 % sin(FI0)
% MPL(4,4) = 0.3;                 % sin(FI1)

MPL(4,1) = lower_factor*19.3e+6;              % C0, Pa
MPL(4,2) = 4e+6;              % C1, Pa
MPL(4,3) = lower_factor*0.259;                 % sin(FI0)
...
MPL(6,1) = lower_factor*19.3e+6;              % C0, Pa
MPL(6,2) = 4e+6;              % C1, Pa
MPL(6,3) = lower_factor*0.259;                 % sin(FI0)
MPL(6,4) = 0.035;                 % sin(FI1)
...
MPL(7,1) = lower_factor*19.3e+6;              % C0, Pa
MPL(7,2) = 4e+6;               % C1, Pa
MPL(7,3) = lower_factor*0.259;               % sin(FI0)
MPL(7,4) = 0.035;               % sin(FI1)
MPL(7,5) = 0;                 % GAM0
MPL(7,6) = 1;                 % GAM1
...
MFLOW(10,2) = 1.5e+5;          % AD, 1/s/MPa^n
MFLOW(10,3) = 3.5;             % n
MFLOW(10,4) = 480;             % Ea, kJ/mol
