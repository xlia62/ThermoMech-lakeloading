...
tau_plastic = 20e6; % years (10^10-10^12), or set to very high for no plastic healing
...
SE = strengthprofile_strongcrust(sed_thick,MRHO(3,:),MFLOW(3,:),MPL(3,:),...
...
save([outpath,'/litho_strength.mat'],'SE'); % notice a factor is added to plot crust
