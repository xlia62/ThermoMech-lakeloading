...
'reference_Tp30/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/Lake_model_extraction/',...
'reference_Tp30/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_model_extraction/reference_Tp30/bounds.mat')
