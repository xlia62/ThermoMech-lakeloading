...
% re-grid in x direction; use for moving high resolution area across model
regridx = false;
...
% bintern = zeros(8,1);
% bintern(1)= -1;%hor_node;      % Horizontal position of vx nodes with prescrbed velocity (no susch condition if negative)
