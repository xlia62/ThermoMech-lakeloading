...
MFLOW(3,1) = 0;               % 0= constant viscosity
MFLOW(3,2) = 1e+21;           % viscosity, Pa s
MFLOW(3,6) = 1;               % Lab to model factor
...
MFLOW(6,1) = 0;               % 0= constant viscosity
MFLOW(6,2) = 1e+21;           % viscosity, Pa s
MFLOW(6,6) = 1;               % Lab to model factor
...
MFLOW(7,1) = 0;               % 0= constant viscosity
MFLOW(7,2) = 1e+21;           % viscosity, Pa s
MFLOW(7,6) = 1;               % Lab to model factor
...
MFLOW(9,1) = 0;               % 0= constant viscosity
MFLOW(9,2) = 1e+22;           % viscosity, Pa s
MFLOW(9,6) = 1;               % Lab to model factor
...
MFLOW(10,2) = 1e+21;           % viscosity, Pa s
MFLOW(10,6) = 1;               % Lab to model factor
...
MFLOW(11,5) = 8;               % Va, cm^3 = = = > *1e-6 for J/Pa, or *0.1 for J/bar
                            % uni-axial compression % Lab to model factor
n = MFLOW(11,3);                            
MFLOW(11,6) = F(n);
...
MFLOW(14,1) = 0;               % 0= constant viscosity
MFLOW(14,2) = 1e+20;           % viscosity, Pa s
MFLOW(14,6) = 1;               % Lab to model factor
