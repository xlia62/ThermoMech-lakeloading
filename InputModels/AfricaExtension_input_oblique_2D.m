...
TheunissenMaterials_oblique_2D
...
elseif seed_type == 3 
    ...
    zweak = 40000;  %width of weak zone
    x1 = x0 - zweak/2;
    x2 = x0 + zweak/2;
...
Tl = 1376;             % Tl = Temperature of the base of mechanical Mantle Lithosphere (oC)
