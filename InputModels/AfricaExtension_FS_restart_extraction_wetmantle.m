...
'reference_wetmantle/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/Lake_model_extraction/',...
'reference_wetmantle/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_model_extraction/reference_wetmantle/bounds.mat')
