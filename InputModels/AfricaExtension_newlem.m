...
% Rheologically/Thermoally Weak spot
xweak = 1000;  %size
yweak = 1000;  %size
x0 = xsize/2; % Horizontal position
y0 = 5000;    % Depth below surface
y0 = y0 + sticky_layer - yweak/2;
x1 = x0 - xweak/2;
x2 = x0 + xweak/2;
y1 = y0 - yweak/2;
y2 = y0 + yweak/2;
...
Tl = 1200+dtpotential;             % Tl = Temperature of the base of Mantle Lithosphere (oC)
...
LEMpar.Fd = 1;    % Effeciency of fluvial sediment deposition, equal to G. 
