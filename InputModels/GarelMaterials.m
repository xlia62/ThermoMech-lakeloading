...
MFLOW(8,2) = 5.0e+5;          % AD, 1/s/MPa^n
MFLOW(8,3) = 3.5;             % n
MFLOW(8,4) = 540;             % Ea, kJ/mol
...
MFLOW(10,2) = 5e+5;          % AD, 1/s/MPa^n
MFLOW(10,3) = 3.5;             % n
MFLOW(10,4) = 540;             % Ea, kJ/mol
...
MFLOW(16,2) = 2e-10;      % AD, 1/s/MPa^n to convert from Pa^n, (1e-6*AD^(-1/n))^-n
MFLOW(16,3) = 1;            % n
