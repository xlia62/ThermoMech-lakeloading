...
MFLOW(4,5) = 0;               % Va, cm^3 = = = > *1e-6 for J/Pa, or *0.1 for J/bar
                            % uni-axial compression % Lab to model factor
n = MFLOW(4,3);                            
MFLOW(4,6) = 0.1;                 % was F(n); now change to 10 to weak it
...
MFLOW(5,5) = 0;               % Va, cm^3  = = = > *1e-6 for J/Pa, or *0.1 for J/bar
                            % uni-axial compression % Lab to model factor
n = MFLOW(5,3);                            
MFLOW(5,6) = 0.1;                 % was F(n); now change to 10 to weak it    
...
MFLOW(6,5) = 0;               % Va, cm^3 = = = > *1e-6 for J/Pa, or *0.1 for J/bar
                            % uni-axial compression % Lab to model factor
n = MFLOW(6,3);                            
MFLOW(6,6) = 0.1;                 % was F(n); now change to 10 to weak it 
...
MFLOW(10,8) = 3e-5;           % was 3e-5, coudl be 45  AD, 1/s/MPa^n (Garelle et al 2014)
MFLOW(10,9) = 1;              % n
