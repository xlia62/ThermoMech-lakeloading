...
MFLOW(8,5)=5;               % Va, cm^3 ===> *1e-6 for J/Pa, or *0.1 for J/bar
MMU(8,1)=6.7e+20;             % shear modulus, Pa
MPL(8,1)=1e+6;              % C0, Pa
MPL(8,2)=1e+6;              % C1, Pa
...
MMU(10,1)=6.7e+20;             % shear modulus, Pa
MPL(10,1)=1e+6;              % C0, Pa
MPL(10,2)=1e+6;              % C1, Pa
...
MPL(10,5)=0;                 % GAM0
MPL(10,6)=1;                 % GAM1
MPL(10,7)=1000e9;               % Maximum yield strength, Pa
...
%      if MY(mm1) > ysize - 400e3 && MX(mm1) >= 1050e3 && MX(mm1) <= 1950e3
%          MTK(mm1) = tbottom + 100;
%      end
    
end

% Add perturbations to kick-start
p = 0.02;  % Percent of amplitude
MTK = MTK + 0.02*MTK.*cos(pi*MX/xsize).*sin(pi*MY/ysize);

% Intialize mantle phase functions
k = MY>= 410e3 & MY<660e3;
MPH410(k,1) = 1;
k = MY>= 660e3;
MPH660(k,1) = 1;

% Initialize the pressure, to be linear using astenospheric density and
% first pressure cell value (should match the boundary condition)
P0 = 1e9;
