...
MPL(1,5)=0;                 % GAM0
MPL(1,6)=1;                 % GAM1
MPL(5,7)=100e6;               % Maximum yield strength, Pa
...
MFLOW(2,2)=1e+20;           % viscosity, Pa s
MFLOW(2,6) = 1;
...
MPL(2,5)=0;                 % GAM0
MPL(2,6)=1;                 % GAM1
MPL(2,7)=100e6;               % Maximum yield strength, Pa
...
MPL(3,3)=0.15;                 % sin(FI0) strong
MPL(3,4)=0.15;                 % sin(FI1) weak
MPL(3,5)=0;                 % GAM0
MPL(3,6)=1;                 % GAM1
MPL(3,7)=100e6;               % Maximum yield strength, Pa
...
MPL(7,5)=0;                 % GAM0
MPL(7,6)=1;                 % GAM1
MPL(7,7)=100e6;               % Maximum yield strength, Pa
MCP(7,1)=10000;                % Cp, J/kg
...
MRHO(8,4) = 2900;            % melt density, kg/m^3   (Gerya and Mellick, 2010)
...
MPL(10,5)=0;                 % GAM0
MPL(10,6)=1;                 % GAM1
MPL(10,7)=100e6;               % Maximum yield strength, Pa
...
% -------------------------------------------------------------------------
MRHO(11,1)=3200;             % standard density, kg/m^3
...
MPL(11,1)=10e+6;              % C0, Pa
MPL(11,2)=10e+6;              % C1, Pa
MPL(11,3)=0.1;               % sin(FI0)
MPL(11,4)=0.1;              % sin(FI1)
MPL(11,5)=0;                 % GAM0
MPL(11,6)=1;                 % GAM1
...
MPL(12,5)=0;                 % GAM0
MPL(12,6)=1;                 % GAM1
MPL(12,7)=100e6;               % Maximum yield strength, Pa
...
MPL(13,5)=0;                 % GAM0
MPL(13,6)=1;                 % GAM1
MPL(13,7)=100e6;               % Maximum yield strength, Pa
...
MPL(15,5)=0;                 % GAM0
MPL(15,6)=1;                 % GAM1
MPL(15,7)=100e6;               % Maximum yield strength, Pa
...
% Diffusion creep in the lower mantle
MFLOW(16,1) = 1;            % 1= power law ( after Garell et al, 2014)
MFLOW(16,2) = 5e-11;      % AD, 1/s/MPa^n (increase to reduce viscosity)
MFLOW(16,3) = 1;            % n
MFLOW(16,4) = 200;          % Ea, kJ/mol
MFLOW(16,5) = 1.5;          % Va, cm^3 = = = > *1e-6 for J/Pa, or *0.1 for J/bar
MFLOW(16,6) = 1;             % uni-axial compression % Lab to model factor
% MFLOW(16,1) = 0;                % Constant
% MFLOW(16,2) = 1e22;             % Pa s
...
MPL(16,5) = 0;                 % GAM0
MPL(16,6) = 1;                 % GAM1
MPL(16,7) = 100e9;             % Maximum yield strength, Pa
...
% -------------------------------------------------------------------------
%% 18 = Perovskite eclogite 
% Only used for tracking, keep same eclogite and change rheology
% to perovskite (type 16)
% -------------------------------------------------------------------------
MRHO(18,:) = MRHO(15,:);
MFLOW(18,:) = MFLOW(16,:);
