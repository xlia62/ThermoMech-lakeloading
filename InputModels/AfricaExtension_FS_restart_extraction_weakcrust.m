...
TheunissenMaterials_withlake_weakcrust_dry
...
'reference_weakcrust_dry/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/Lake_model_extraction/',...
'reference_weakcrust_dry/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_model_extraction/reference_weakcrust_dry/bounds.mat')
