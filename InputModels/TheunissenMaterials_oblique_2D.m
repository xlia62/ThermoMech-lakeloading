...
% -------------------------------------------------------------------------
MRHO(7,1) = 2700;%2900;             % standard density, kg/m^3
...
MFLOW(7,2) = 7.13e-4;          % AD, 1/s/MPa^n
MFLOW(7,3) = 3;             % n
MFLOW(7,4) = 345;             % Ea, kJ/mol
...
% -------------------------------------------------------------------------
%% 19 = Upper continental crust (granodiorite) stripe
% -------------------------------------------------------------------------
MRHO(19,:) = MRHO(6,:);
MFLOW(19,:) = MFLOW(6,:);

MMU(19,1) = MMU(6,1);             % shear modulus, Pa
MPL(19,:) = MPL(6,:);
MCP(19,1) = MCP(6,1);                % Cp, J/kg
MKT(19,:) = MKT(6,:);
MHR(19,1) = MHR(6,1);              % radiogenic heat production, W/m^3
MHE(19,1) = MHE(6,1);                 % shear and adiobatic heating efficiency


% -------------------------------------------------------------------------
%% 20 = Lower continental crust (diorite) stripe
% -------------------------------------------------------------------------
MRHO(20,:) = MRHO(7,:);
MFLOW(20,:) = MFLOW(7,:);

MMU(20,1) = MMU(7,1);             % shear modulus, Pa
MPL(20,:) = MPL(7,:);
MCP(20,1) = MCP(7,1);                % Cp, J/kg
MKT(20,:) = MKT(7,:);
MHR(20,1) = MHR(7,1);              % radiogenic heat production, W/m^3
MHE(20,1) = MHE(7,1);                 % shear and adiobatic heating efficiency
