...
MatProp{5} = 'Lower Oceanic Crust'; % <---- changed to Upper Cont - measuring layer for deformation tracking
...
MatProp{11} = 'Weaker Upper Continetnal Crust -- Fault';   %<---- changed from hydrated mantle
...
MMU(4,1) = 1e+11;               % shear modulus, Pa
MPL(4,1) = 10e+6;              % C0, Pa
MPL(4,2) = 1e+6;              % C1, Pa
MPL(4,3) = 0.6;                 % sin(FI0)
MPL(4,4) = 0.3;                 % sin(FI1)
...
% -------------------------------------------------------------------------
MRHO(5,1) = 2700;             % standard density, kg/m^3
...
MFLOW(5,2) = 3.2e-4;          % AD, 1/s/MPa^n
MFLOW(5,3) = 2.3;             % n
MFLOW(5,4) = 154;             % Ea, kJ/mol
MFLOW(5,5) = 0;               % Va, cm^3  = = = > *1e-6 for J/Pa, or *0.1 for J/bar
                            % uni-axial compression % Lab to model factor
n = MFLOW(5,3);                            
MFLOW(5,6) = F(n);    

MMU(5,1) = 1e+11;             % shear modulus, Pa
MPL(5,1) = 10e+6;              % C0, Pa
MPL(5,2) = 1e+6;              % C1, Pa
...
MHR(5,1) = 1.0e-6;              % radiogenic heat production, W/m^3
...
MMU(6,1) = 1e+11;               % shear modulus, Pa
MPL(6,1) = 10e+6;              % C0, Pa
MPL(6,2) = 1e+6;              % C1, Pa
MPL(6,3) = 0.6;                 % sin(FI0)
MPL(6,4) = 0.3;                 % sin(FI1)
...
MFLOW(10,2) = 1.1e+5;          % AD, 1/s/MPa^n
MFLOW(10,3) = 3.5;             % n
MFLOW(10,4) = 530;             % Ea, kJ/mol
MFLOW(10,5) = 0;              % Va, cm^3 = = = > *1e-6 for J/Pa, or *0.1 for J/bar
                              % uni-axial compression % Lab to model factor                            
n = MFLOW(10,3);                            
MFLOW(10,6) = F(n);  
...
MPL(10,1) = 2e+6;              % C0, Pa
MPL(10,2) = 2e+6;              % C1, Pa
MPL(10,3) = 0.2;               % sin(FI0) friction coefficient
