...
'Lake_drop_restart_thermodynamic_reference_dtp100/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/',...
'Lake_drop_restart_thermodynamic_reference_dtp100/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_drop_restart_thermodynamic_reference_dtp100/bounds.mat')
...
water_lev_bot = 20800; % min of lake levle 
period = 400; %kyr 
