...
'reference_LAB70/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/Lake_model_extraction/',...
'reference_LAB70/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_model_extraction/reference/bounds.mat')
