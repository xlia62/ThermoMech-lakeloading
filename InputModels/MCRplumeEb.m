...
m_mlith = (tLAB - tmoho) / (LAB_depth - crust_thick);
...
k = SE.z <= (adiabat_depth-sticky_layer);
z = SE.z(k);
SE.T(k) = m_mlith*z + b_mlith;

k = SE.z <= crust_thick;
z = SE.z(k);
SE.T(k) = m_crust*z + b_crust;

% 2nd Invariant Strain-rate (m/s) used for YSE calculations
eii = 1.6e-15;  
S.eii = eii;
