...
for mm1 = 1:marknum
    ...
    % Weak zone
     if (MY(mm1)> sticky_layer && MY(mm1)<=oceanLAB_young && MX(mm1)>= xsize0 - oceanic_lith_thick_young)
 %         MI(mm1) = 11;
     end
     if (MY(mm1)> sticky_layer && MY(mm1)<=oceanLAB_old && MX(mm1)<=oceanic_lith_thick_old)
          MI(mm1) = 11;
     end
end
