...
contLAB = 65000 + sticky_layer + upper_cont_thick + lower_cont_thick;
...
tbottom = tpotential - tabsolute + tgrad*(ysize-sticky_layer);
...
% % %     end
    ...
    % Bottom of sediments
    bot_sed = sed_thick;
    if(MY(mm1)>sticky_layer && MY(mm1)<= bot_sed && MX(mm1)>=14000 && MX(mm1)<=700000)
        MI(mm1)=3;
    end
    ...
    if(MY(mm1)>bot_sed && MY(mm1)<=bot_icrust1 && MX(mm1)>=14000 && MX(mm1)<=700000)
        MI(mm1)=6;
    end
    ...
    if(MY(mm1)>bot_icrust1 && MY(mm1)<=bot_icrust2 && MX(mm1)>=14000 && MX(mm1)<=700000)
        MI(mm1)=7;
    end
    
    % Continetal lab
    if(MY(mm1)>bot_icrust2 && MY(mm1)<=contLAB && MX(mm1)>=14000 && MX(mm1)<=700000)
        MI(mm1) = 9;
    end
