...
'Lake_drop_restart_thermodynamic_reference/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/',...
'Lake_drop_restart_thermodynamic_reference/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_drop_restart_thermodynamic_reference/bounds.mat')
...
water_lev_bot = 20300; % min of lake level, 800 m water level change, was 24000
