...
'Lake_drop_restart_thermodynamic_reference_lab70/markers_',num2str(step2restart),'.mat'])
load(['../output/AfricaModels2022/',...
'Lake_drop_restart_thermodynamic_reference_lab70/grids_',num2str(step2restart),'.mat'])
load('../output/AfricaModels2022/Lake_drop_restart_thermodynamic_reference_lab70/bounds.mat')
