...
MPL(1,5)=0;                 % GAM0
MPL(1,6)=1;                 % GAM1
MPL(1,7)=1000e6;               % Maximum yield strength, Pa
...
MPL(2,5)=0;                 % GAM0
MPL(2,6)=1;                 % GAM1
MPL(2,7)=1000e6;               % Maximum yield strength, Pa
...
MPL(3,1)=1e+6;              % C0, Pa
MPL(3,2)=1e+6;              % C1, Pa
MPL(3,3)=0.6;              % sin(FI0) strong%0.15
...
MKT(3,2)=807;               % a, W/m
MHR(3,1)=2.7e-6;            % radiogenic heat production, W/m^3
...
% -------------------------------------------------------------------------
% 6 = Upper continental crust (granodiorite)markercolorsplume
% -------------------------------------------------------------------------
...
MKT(6,2)=807;               % a, W/m
MHR(6,1)=1.14e-6;              % radiogenic heat production, W/m^3%2.0e-6
...
MRHO(9,5) = -10;             % depletion (compositional density constrast) kg/m^3
MFLOW(9,1)= 1;               % 1=power law (dry olivine: Ranalli, 1995)
MFLOW(9,2)= 2.5e+4;          % AD, 1/s/MPa^n
MFLOW(9,3)=3.5;              % n
MFLOW(9,4)=500;              % Ea, kJ/mol
MFLOW(9,5)=5;               % Va, cm^3
...
% -------------------------------------------------------------------------
MRHO(11,1)=3300-150;             % standard density, kg/m^3
...
MRHO(14,5)= 0;                % Compositional density, slow the plume down
...
zmax = xsize-sticky_layer;    % Depth of geotherm for strength envelop and lithosphere
