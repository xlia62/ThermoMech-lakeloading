...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    ...
    case 1.3
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_1000m_revz_dry';
    ...
    case 1.4
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_nochange_restart_71_1000m_rev_dry';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    case 2.1  % lake level change of 600 m
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_600m_dry';  
    ...
    case 2.2  % lake level change of 300 m
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_300m_dry';
        
    case 2.3  % lake level change of 1500 m
        output_freq = 5e3;
        restart = true; 
        step2restart = 71;
        InputModel = 'InputModels/AfricaExtension_FS_restart_extraction';
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_1500m_dry';  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
    ...
    case 3.5
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_v27_dry';        
    ...
    case 3.6
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_nochange_restart_71_v27_dry';        
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    case 4.1
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_LAB65_dry';  
    ...
    case 4.2
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_nochange_restart_71_LAB65_dry';  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    case 5.1
        ...
        step2restart = 71; %44;
        max_lake_level_change = 1000; 
        InputModel = 'InputModels/AfricaExtension_FS_restart_extraction_Tp10';
        lake_level_change = true;
        % step71:14.0419 Ma 
        % period = 0.1Ma, buffer= 0.075Ma
        % total time = 0.1*2+0.075*2 =0.35
        ...
        dtpotential = 10;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_1000m_Tp10_dry';  
    ...
    case 5.2
        ...
        dtpotential = 10;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_nochange_restart_71_1000m_Tp10_dry';  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    case 7.1
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_weakcrust_dry';
    ...
    case 7.2
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_nochange_restart_71_weakcrust_dry';
     ...
     case 7.3
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_strongcrust_dry';
     ...
     case 7.4
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_nochange_restart_71_strongcrust_dry';     
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    case 8.1  % lake level change of one period
        ...
        dtpotential = 0;
        tmoho = 550;                    
        OutputDIR = 'output/AfricaModels2022/Lake_model_extraction/Lake_drop_restart_71_oneperiod_dry';          
