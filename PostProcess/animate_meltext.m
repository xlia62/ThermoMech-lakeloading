function animate_meltext(inpath,nfreq,ntotal,npx,npy,cmap,tempc,xlims,ylims)
...
for j = k
    ...
    [mx,my,markermext] = vis_markers((xlims-ox)*1000,(ylims-oy)*1000,npx,npy,mx,my,100*mext);
    ...
    clf
    pcolor(mx/1000,my/1000,markermext);    hold on
    if ~isempty(tempc)
