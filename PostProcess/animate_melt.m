function animate_melt(inpath,nfreq,ntotal,npx,npy,cmap,tempc,xlims,ylims)
...
for j = k
    ...
    [mx,my,markermxm] = vis_markers((xlims-ox)*1000,(ylims-oy)*1000,npx,npy,mx,my,100*mxm);
    ...
    clf
    pcolor(mx/1000,my/1000,markermxm);    hold on
    if ~isempty(tempc)
