...
for j = k
    ...
    scatter(mx(astheno),my(astheno),marker_size,'MarkerFaceColor',ast,'MarkerEdgeColor',ast,...
        'MarkerFaceAlpha',factor,'MarkerEdgeAlpha',factor)
    hold on
...
%         'MarkerFaceAlpha',.2,'MarkerEdgeAlpha',.2)
    ...
    clabel(con, h,  'Fontsize', 25, 'Color', 'white', 'labelspacing', 1000);
    ...
    title(['Step:',num2str(round(j,2)),', Model time: ',num2str(round (timesum*1e-6/(yr2sec), 2)), ' Myr']);
