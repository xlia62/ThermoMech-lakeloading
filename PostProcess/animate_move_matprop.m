function animate_move_matprop(inpath,nfreq,ntotal,npx,npy,cmap,tempc,xlims0,ylims,v0,movie_out)
...
for j = k
    ...
    xlims = xlims0 + v0*timesum/yr2sec;
    ...
    title(['Material Properties: ',num2str(round(timesum*1e-6/(yr2sec),2)),' Myr'],'FontSize', 16);
